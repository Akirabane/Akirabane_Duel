package fr.akirabane.akirabaneduel;
...
import fr.akirabane.akirabaneduel.listeners.DamageListeners;
import fr.akirabane.akirabaneduel.listeners.PlayerListeners;
...
public class Main extends JavaPlugin{
	...
	public void onEnable() {
        ...
        spawn.add(new Location(world, -140.555, 81, -42.555, 180.0f, 0.0f));
        spawn.add(new Location(world, -140.555, 81, -48.555, 0.0f, 0.0f));
